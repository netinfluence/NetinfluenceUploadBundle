        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('filesystems')
                    ...
                    ->isRequired()
                ->end()
                ->booleanNode('ignore_delete_error')
                    ->info('Whether to ignore filesystems errors happening during removal. True is advised, usually permission issues should not prevent users from deleting objects.')
                    ->defaultValue(true)
                ->end()
